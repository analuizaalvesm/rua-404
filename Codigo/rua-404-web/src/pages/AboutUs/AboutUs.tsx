  ...
  const members = [
    {
      ...
      description:
        "Iniciou sua carreira de programador em 2018 e hoje atua com desenvolvimento mobile. É entusiasta de realidade aumentada e idealiza produtos que unem arte e tecnologia.",
      image:
        "https://i.postimg.cc/W3rdnTbH/433317805-3824953447776347-5350987117070313789-n.jpg",
    },
    {
      id: 2,
      name: "Fred Bernardes",
      ...
      description:
        "Começou no design em 2015, tendo foco em composição de vídeo mais voltado para animação gráfica. Hoje, trabalha como Motion Designer e é um dos fundadores do Rua 4.0.4.",
      image:
        "https://i.postimg.cc/NfG1g20G/279515636-3101708033412037-750311692102704057-n.jpg",
    },
    {
      id: 3,
      name: "Lucas Zatta",
      ...
      description:
        "Artista visual e programador, Zatta é apaixonado por arte urbana e tecnologia. No tempo livre, gosta de criar experiências visuais imersivas e interativas para o Rua 4.0.4.",
      image:
        "https://i.postimg.cc/5yV6KTXN/376857149-760134895881446-3542992875454547472-n.jpg",
    },
  ];
  ...
  const collaborations = [
    {
      ...
      description:
        "Parceria que uniu arte digital e intervenção urbana em um projeto inovador de stickers e mídia experimental.",
    ...
    },
    {
      ...
      description:
        "Colaboração que expandiu os limites da arte de rua através de técnicas mistas de design e street art.",
  ...
  const productHighlights = [
    {
      ...
      name: "Sticker Packs",
      description:
        "Coleções exclusivas que capturam a essência da arte urbana digital.",
    ...
    },
    {
      ...
      description:
        "Arte em papel de alta qualidade, capturando momentos e intervenções urbanas.",
    ...
    },
    {
      ...
      name: "Pins & Buttons",
      description:
        "Acessórios exclusivos para quem quer levar a arte urbana para onde for.",
          ...
          <div className="flex items-center">
            <div className="py-14">
              ...
              <p className="text-gray-600 text-center text-lg text-white leading-relaxed mt-8 px-32">
                Rua 4.0.4 é mais do que um coletivo. Somos uma plataforma que
                reimagina a arte urbana através da tecnologia, criando pontes
                entre o digital e o físico, o local e o global, o tradicional e
                o experimental.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-12">
          <div>
            <p className="text-lg text-gray-700 leading-relaxed">
              Fundada em 2020, a Rua 4.0.4 nasceu da intersecção entre arte
              urbana e tecnologia digital. Nosso objetivo é transformar espaços
              urbanos em telas interativas, onde cada intervenção é uma
              narrativa, cada sticker uma mensagem, cada print uma experiência.
            </p>
          </div>
          <div>
            <p className="text-lg text-gray-700 leading-relaxed">
              Acreditamos que a arte não precisa estar confinada em galerias.
              Ela deve ser viva, dinâmica e acessível. Por isso, levamos nossa
              arte para as ruas, muros, e agora, para plataformas digitais,
              criando um ecossistema onde a criatividade não conhece limites.
            </p>
          </div>
        </div>
          ...
          {collaborations.map((collab) => (
            ...
            >
              <div className="flex items-center justify-between bg-gray-200 border-b-2 border-black">
                <p className="text-xs font-orbitron-bold text-gray-800 uppercase pl-4">
                  RUA.EXE
                </p>
                <div className="flex">
        ...
        <section className="mx-auto max-w-screen-2xl px-16">
          ...
          <div className="grid grid-cols-3 gap-6">
            {productHighlights.map((product) => (
              <div key={product.id} className="border border-white p-6">
