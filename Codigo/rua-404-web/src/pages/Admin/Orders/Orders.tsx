...
const Orders: React.FC = () => {
    ...
    const filtered = orders.filter(
      (order) =>
        ...
        (order.usuario.first_name &&
          order.usuario.first_name.toLowerCase().includes(query)) ||
        (order.usuario.last_name &&
          order.usuario.last_name.toLowerCase().includes(query))
    );
  ...
  //             <span className="font-semibold text-black">Pedido #{order.id}</span>
  //           </div>
  //           <svg
  //             className="mt-0 pt-2 w-full"
  //             width="1216"
  //             height="2"
  //             viewBox="0 0 1216 2"
  //             fill="none"
  ...
  //             {order.usuario.email} - {order.usuario.telefone}
  //           </div>
  //           <div className="text-sm text-gray-500 font-regular flex items-center px-3">
  ...
  //                   ", " +
  //                   order.usuario.address.numero +
  //                   ", " +
  //                   order.usuario.address.complemento}{" "}
  //                 - {order.usuario.address.bairro}
  //                 <br />
  //                 {order.usuario.address.cidade}/{order.usuario.address.estado} -
