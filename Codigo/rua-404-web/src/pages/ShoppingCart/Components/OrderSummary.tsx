...
const OrderSummary = ({
  ...
  return (
    <div className="space-y-4 rounded-sm border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
      ...
      <div className="space-y-4 rounded-sm border border-gray-200 bg-[#fafafa] p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-5">
          ...
          <div>
            ...
            <div className="flex flex-row items-center space-x-2">
              <input
                type="text"
                id="voucher"
                className="block w-2/3 rounded-sm border border-gray-300 bg-white p-2 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
