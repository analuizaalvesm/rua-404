      ...
      <div className="mx-auto w-full h-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a
              href="https://instagram.com/rua4.0.4"
              className="flex items-center"
            >
              <img src={logo} className="h-16 me-3" alt="Rua 404 Logo" />
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-slate-200">
                Sobre
              </h2>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 text-white">
                Dúvidas Frequentes
              </h2>
              <ul className="text-gray-300 dark:text-gray-400 font-medium">
                <li className="mb-4">
